...
inline const double PERLIN_FREQUENCY = 1.0;
inline const double PERLIN_PERSISTENCE = 0.5;
inline const double PERLIN_LACUNARITY = 2.0;
inline const double PERLIN_OCTAVE_COUNT = 6.0;
